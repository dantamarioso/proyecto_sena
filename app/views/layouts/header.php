...
<head>
    ...
    <script>
        ...
        const currentProtocol = window.location.protocol; // https: o http:
        ...
        // Verificar que sea HTTPS en ngrok
        if (window.location.host.includes('ngrok') && currentProtocol === 'http:') {
            console.warn('ADVERTENCIA: ngrok debe usar HTTPS. Redirigiendo...');
